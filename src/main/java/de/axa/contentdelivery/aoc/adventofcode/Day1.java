...
public class Day1 {
    ...
    public static void solve() {
        ...
        Optional<Elf> topElf = ElfFactory.getElfStream().sorted(elfComparator.reversed()).collect(Collectors.maxBy(elfComparator));
        ...
        Integer foodTop3Elfes = ElfFactory.getElfStream().sorted(elfComparator.reversed()).limit(3).collect(Collectors.summingInt(Elf::getFood));
